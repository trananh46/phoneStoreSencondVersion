...
public class CustomerPhoneProductController {
	...
	@GetMapping("/display-all-phone-product")
	public String displayAllPhoneProduct(Model model) {
		...
		List<DisplayProductCustomer> l = phoneProductService.displayAllProductCustomer();
